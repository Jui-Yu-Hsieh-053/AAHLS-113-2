...
set portList { 
	...
	{ shift_reg_address0 sc_out sc_lv 4 signal 0 } 
	{ shift_reg_ce0 sc_out sc_logic 1 signal 0 } 
	{ shift_reg_we0 sc_out sc_logic 1 signal 0 } 
	{ shift_reg_d0 sc_out sc_lv 32 signal 0 } 
	{ shift_reg_address1 sc_out sc_lv 4 signal 0 } 
	{ shift_reg_ce1 sc_out sc_logic 1 signal 0 } 
	{ shift_reg_q1 sc_in sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	shift_reg { ap_memory {  { shift_reg_address0 mem_address 1 4 }  { shift_reg_ce0 mem_ce 1 1 }  { shift_reg_we0 mem_we 1 1 }  { shift_reg_d0 mem_din 1 32 }  { shift_reg_address1 MemPortADDR2 1 4 }  { shift_reg_ce1 MemPortCE2 1 1 }  { shift_reg_q1 in_data 0 32 } } }
}
