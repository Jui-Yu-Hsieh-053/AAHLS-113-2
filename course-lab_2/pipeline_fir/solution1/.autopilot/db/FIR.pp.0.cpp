# 1 "pipeline_example_fir/FIR.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "pipeline_example_fir/FIR.cpp" 2
# 1 "pipeline_example_fir/FIR.h" 1
...
# 4 "pipeline_example_fir/FIR.h" 2

typedef int data_t;
typedef int coef_t;
typedef int acc_t;
__attribute__((sdx_kernel("fir", 0))) void fir(data_t *y, data_t x);
# 2 "pipeline_example_fir/FIR.cpp" 2
# 29 "pipeline_example_fir/FIR.cpp"
__attribute__((sdx_kernel("fir", 0))) void fir(data_t *y, data_t x) {
#line 15 "/home/ubuntu/course-lab_2/pipeline_fir/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 29 "pipeline_example_fir/FIR.cpp"

#line 6 "/home/ubuntu/course-lab_2/pipeline_fir/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=fir
# 29 "pipeline_example_fir/FIR.cpp"

coef_t c[11] = {53, 0, -91, 0, 313, 500, 313, 0,-91, 0, 52};
